...
<style>
    .page-title { font-family: 'Quicksand', sans-serif !important; font-weight: 700; font-size: 2.2rem; }
    .section-heading { font-family: 'Quicksand', sans-serif !important; font-weight: 700; font-size: 1.8rem; }    
    ...
    .tour-slider-wrapper .tour-card-v2 { flex: 0 0 calc((100% - 40px) / 3); margin-bottom: 0; }
    
    @media (max-width: 992px) { .tour-slider-wrapper .tour-card-v2 { flex: 0 0 calc((100% - 20px) / 2); } }
    @media (max-width: 576px) { .tour-slider-wrapper .tour-card-v2 { flex: 0 0 100%; } }
    
    .slider-arrow {
        position: absolute; top: 50%; transform: translateY(-50%); width: 40px; height: 40px; background: #fff; border: 1px solid #00712D; color: #00712D; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; cursor: pointer; z-index: 10; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: all 0.3s ease;
    }
    .slider-arrow:hover { background: #00712D; color: #fff; }
    .slider-arrow.prev { left: -20px; }
    .slider-arrow.next { right: -20px; }

    /* KHU VỰC ƯU ĐÃI NỔI BẬT */
    .promo-highlight-section {
        background: linear-gradient(135deg, #E31837 0%, #B30B1F 100%); border-radius: 20px; padding: 30px; margin-top: 50px; margin-bottom: 50px; position: relative; box-shadow: 0 10px 30px rgba(227, 24, 55, 0.25);
    }
    .promo-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; color: white; }
    .promo-title-wrap h4 { font-family: 'Quicksand', sans-serif; font-weight: 800; font-size: 2.2rem; margin-bottom: 5px; display: flex; align-items: center; gap: 12px; }
    .promo-subtitle { font-size: 1.05rem; opacity: 0.95; font-weight: 500; }
    .btn-view-more { background: transparent; color: white; border: 1px solid white; border-radius: 30px; padding: 8px 24px; font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 10px; transition: 0.3s; }
    .btn-view-more:hover { background: white; color: #E31837; }
    .promo-highlight-section .slider-arrow { background: rgba(255, 255, 255, 0.15); border: 1px solid rgba(255,255,255,0.4); color: white; }
    .promo-highlight-section .slider-arrow:hover { background: white; color: #E31837; }
    .promo-highlight-section .tour-card-v2 { border: none !important; box-shadow: 0 6px 20px rgba(0,0,0,0.15); }
    
    /* KHU VỰC TOUR GỢI Ý */
    .suggested-highlight-section {
        background: linear-gradient(135deg, #F9A826 0%, #E67E22 100%); border-radius: 20px; padding: 30px; margin-top: 20px; margin-bottom: 50px; position: relative; box-shadow: 0 10px 30px rgba(230, 126, 34, 0.25);
    }
    .suggested-highlight-section .slider-arrow { background: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255,255,255,0.5); color: white; }
    .suggested-highlight-section .slider-arrow:hover { background: white; color: #E67E22; }
    .suggested-highlight-section .tour-card-v2 { border: none !important; box-shadow: 0 6px 20px rgba(0,0,0,0.1); }
</style>
...
<main class="container" style="padding-top: 40px; padding-bottom: 80px;">
    <ul class="nav nav-pills custom-nav-pills justify-content-center" id="mytripTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#chuahoanthanh" type="button">Chưa hoàn thành</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#dahoanthanh" type="button">Đã hoàn thành</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#dahuy" type="button">Đã hủy</button>
        </li>
    </ul>
                        ...
                        <div class="booked-trip-card">
                            ...
                            <div class="btc-body">
                                ...
                                <div class="btc-status-row">
                                    <?php if (!empty($row['HuyTrangThai']) && $row['HuyTrangThai'] === 'Chưa xử lý'): ?>
                                        <div class="btc-status text-warning fw-bold"><i class="fa-solid fa-hourglass-half"></i> Đang chờ duyệt hủy</div>
                                    <?php else: ?>
