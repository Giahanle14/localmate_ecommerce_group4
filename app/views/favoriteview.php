...
<main class="container py-4" style="min-height: 65vh;">
    ...
    <div class="text-center mb-5 mt-2">
        <h2 class="d-inline-block px-5 py-2 text-white fw-bold rounded-pill" style="background-color: var(--color-primary-dark); font-size: 1.3rem;">
            Danh sách Yêu thích
        </h2>
    </div>
                    ...
                    <div class="tour-card-body bg-white">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <!-- Link điều hướng sang trang Chi tiết tour -->
                                <a href="?controller=tour&action=detail&id=<?= $tour['MaTour'] ?>" class="btn btn-outline-success btn-sm rounded-pill px-3 fw-bold">Chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    // Validate tầng View: Chặn người dùng nhấn "Khám phá" (Tìm kiếm) nếu chưa nhập gì
        ...
        .then(data => {
            ...
            if (data.success) {
                if (data.action === 'added') {
                    ...
                    countSpan.innerText = count - 1;
                    // Lựa chọn: Nếu muốn tour biến mất khỏi danh sách sau khi bỏ tim, có thể reload trang:
